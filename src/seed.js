    ...
    const rooms = [
      {
        ...
        floor: "1st Floor", capacity: 2, hourlyRate: 4,
      ...
      },
      {
        ...
        floor: "2nd Floor", capacity: 6, hourlyRate: 8,
      ...
      },
      {
        ...
        floor: "3rd Floor", capacity: 3, hourlyRate: 7,
      ...
      },
      {
        ...
        floor: "2nd Floor", capacity: 8, hourlyRate: 10,
      ...
      },
      {
        ...
        floor: "4th Floor", capacity: 5, hourlyRate: 9,
      ...
      },
      {
        ...
        floor: "1st Floor", capacity: 4, hourlyRate: 5,
        amenities: ["Wi-Fi", "Quiet Zone", "Power Outlets"],
        owner: user._id,
      },
      {
        ...
        floor: "5th Floor", capacity: 7, hourlyRate: 11,
      ...
      },
      {
        ...
        image: "https://images.unsplash.com/photo-1497366754035-f200968a6e72?w=800",
        floor: "4th Floor", capacity: 6, hourlyRate: 9,
      ...
      },
      {
        ...
        image: "https://images.unsplash.com/photo-1524758631624-e2822e304c36?w=800",
        floor: "2nd Floor", capacity: 4, hourlyRate: 6,
        amenities: ["Quiet Zone", "Wi-Fi", "Air Conditioning"],
        owner: user._id,
      },
      {
        ...
        image: "https://images.unsplash.com/photo-1497366811353-6870744d04b2?w=800",
        floor: "5th Floor", capacity: 5, hourlyRate: 8,
      ...
      },
      {
        ...
        image: "https://images.unsplash.com/photo-1519389950473-47ba0277781c?w=800",
        floor: "1st Floor", capacity: 3, hourlyRate: 5,
      ...
      },
      {
        ...
        floor: "6th Floor", capacity: 1, hourlyRate: 18,
        amenities: ["Quiet Zone", "Wi-Fi", "Air Conditioning", "Power Outlets", "Whiteboard"],
        owner: user._id,
      },
      {
        name: "Group Project Studio",
        description: "Spacious studio room designed for large group projects and workshops.",
        image: "https://images.unsplash.com/photo-1504384308090-c894fdcc538d?w=800",
        floor: "3rd Floor", capacity: 10, hourlyRate: 14,
        amenities: ["Whiteboard", "Projector", "Wi-Fi", "Power Outlets", "Air Conditioning"],
        owner: user._id,
      },
      {
        name: "Language Practice Room",
        description: "Soundproofed room ideal for language practice and oral presentations.",
        image: "https://images.unsplash.com/photo-1497366412874-3415097a27e7?w=800",
        floor: "3rd Floor", capacity: 4, hourlyRate: 7,
        amenities: ["Quiet Zone", "Wi-Fi", "Power Outlets"],
        owner: user._id,
      },
      {
        name: "Science Study Lab",
        description: "Equipped for STEM students with whiteboard and projector access.",
        image: "https://images.unsplash.com/photo-1497366858526-0766cadbe8fa?w=800",
        floor: "4th Floor", capacity: 6, hourlyRate: 10,
        amenities: ["Whiteboard", "Projector", "Wi-Fi", "Power Outlets"],
        owner: user._id,
      },
      {
        name: "Thesis Writing Room",
        description: "Private quiet room for postgraduate thesis and dissertation writing.",
        image: "https://images.unsplash.com/photo-1497366216548-37526070297c?w=800",
        floor: "6th Floor", capacity: 2, hourlyRate: 12,
        amenities: ["Quiet Zone", "Wi-Fi", "Air Conditioning", "Power Outlets"],
        owner: user._id,
      },
      {
        name: "Multimedia Learning Pod",
        description: "Compact pod with display screen for multimedia study sessions.",
        image: "https://images.unsplash.com/photo-1519389950473-47ba0277781c?w=800",
        floor: "2nd Floor", capacity: 3, hourlyRate: 8,
        amenities: ["Projector", "Wi-Fi", "Power Outlets"],
        owner: user._id,
      },
      {
        name: "Open Collaboration Hub",
        description: "Large open space for interdisciplinary collaboration and events.",
        image: "https://images.unsplash.com/photo-1524758631624-e2822e304c36?w=800",
        floor: "5th Floor", capacity: 12, hourlyRate: 16,
        amenities: ["Whiteboard", "Projector", "Wi-Fi", "Power Outlets", "Air Conditioning"],
        owner: user._id,
      },
      {
        name: "Evening Study Suite",
        description: "Comfortable room available for extended evening study sessions.",
        image: "https://images.unsplash.com/photo-1497366754035-f200968a6e72?w=800",
        floor: "1st Floor", capacity: 4, hourlyRate: 6,
        amenities: ["Wi-Fi", "Power Outlets", "Air Conditioning"],
        owner: user._id,
      },
      {
        name: "VIP Scholar Lounge",
        description: "Exclusive lounge for senior scholars with premium amenities.",
        image: "https://images.unsplash.com/photo-1497366811353-6870744d04b2?w=800",
        floor: "6th Floor", capacity: 3, hourlyRate: 20,
        amenities: ["Quiet Zone", "Wi-Fi", "Air Conditioning", "Power Outlets", "Whiteboard", "Projector"],
        owner: user._id,
      },
    ];
